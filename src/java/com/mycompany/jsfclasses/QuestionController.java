...
public class QuestionController implements Serializable {
    ...
    public String getYoutubecode()
    {
        ...
        Matcher matcher = compiledPattern.matcher(selected.getMediaPath()); //url is youtube url for which you want to extract the id.
        if (matcher.find()) {
    ...
    {
        System.out.println("media path is " + selected.getMediaPath() + " and is returning " +  
                (selected.getMediaPath().contains("youtube.com")
                || selected.getMediaPath().contains("youtu.be")));
        return selected.getMediaPath().contains("youtube.com")
                || selected.getMediaPath().contains("youtu.be");
    }
    
    public void setYoutube(boolean youtube)
    {
        youtube = selected.getMediaPath().contains("youtube.com")
                || selected.getMediaPath().contains("youtu.be");
    }
